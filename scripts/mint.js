...
const CONTRACT_ADDRESS = "0x9C04025e5D8340C847757991c761bc6984Cba064";
const TOKEN_BASE_URI =  "https://gateway.pinata.cloud/QmNXeFDc1Ub6Xs61U1wTxwsxXFa9m1C2hS8TbZU3miPdcA";
...
async function main(payload) {
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    await nft.safeTransfer(address, token_uri, {
      nonce: nonce + i,
    });
